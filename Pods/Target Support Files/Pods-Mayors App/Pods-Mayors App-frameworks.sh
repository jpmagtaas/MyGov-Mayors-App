...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EAAlertView/EAAlertView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LGAlertView/LGAlertView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LGSideMenuController/LGSideMenuController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MTSlideToOpen/MTSlideToOpen.framework"
